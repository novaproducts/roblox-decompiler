...
const TextEditor::Palette& TextEditor::GetDarkPalette()
{
	const static Palette p = { {
			...
			0xff6a9955,	// Preprocessor
			0xff9cdcfe, // Identifier
			0xff4ec9b0, // Known identifier
			0xff9cdcfe, // Preproc identifier
			0xff6a9955, // Comment (single line)
			0xff6a9955, // Comment (multi line)
			0xff1e1e1e, // Background
			0xffe0e0e0, // Cursor
			0x4026262a, // Selection
			0x80ff0000, // ErrorMarker
			0x60f08000, // Breakpoint
			0xff858585, // Line number
			0x40ffffff, // Current line fill
			0x20ffffff, // Current line fill (inactive)
			0x2affffff, // Current line edge
		} };
	return p;
}
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			...
			"task", "buffer",
			"game", "workspace", "script", "shared", "settings", "UserSettings", "Enum", "plugin", "pluginManager", "stats",
			"elapsedTime", "tick", "wait", "delay", "spawn", "printidentity",
			"Instance", "Vector2", "Vector3", "Vector2int16", "Vector3int16", "CFrame", "Color3", "BrickColor", "UDim", "UDim2",
			"Ray", "Region3", "Region3int16", "NumberRange", "NumberSequence", "NumberSequenceKeypoint",
			"ColorSequence", "ColorSequenceKeypoint", "PhysicalProperties", "OverlapParams", "CatalogSearchParams",
			"PathWaypoint", "Faces", "Axes", "Random", "DateTime", "TweenInfo", "DockWidgetPluginGuiInfo", "EnumItem", "Font",
			"new", "fromRGB", "fromHSV", "now", "fromUnixTimestamp", "fromUnixTimestampMillis", "fromIsoDate", "fromLocalTime"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
